...
package co.topl.daml.models {
  package Topl {
    final case class MintAssetOffChain(recipient: ` lfdomainapi`.Primitive.Party, nonce: ` lfdomainapi`.Primitive.Text, id: ` lfdomainapi`.Primitive.Text, evidence: ` lfdomainapi`.Primitive.Text, quantity: ` lfdomainapi`.Primitive.Text, assetCode: ` lfdomainapi`.Primitive.Text, metadata: ` lfdomainapi`.Primitive.Text, securityRoot: ` lfdomainapi`.Primitive.Text) extends ` lfdomainapi`.ValueRef

    object MintAssetOffChain extends ` lfdomainapi`.ValueRefCompanion with _root_.scala.Function8[` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, ` lfdomainapi`.Primitive.Text, _root_.co.topl.daml.models.Topl.MintAssetOffChain] {
      ...
      implicit val `MintAssetOffChain Value`: ` lfdomainapi`.Value[_root_.co.topl.daml.models.Topl.MintAssetOffChain] = {
        final class $anon extends this.`Value ValueRef`[_root_.co.topl.daml.models.Topl.MintAssetOffChain] {
          override def write(value: _root_.co.topl.daml.models.Topl.MintAssetOffChain): ` rpcvalue`.Value.Sum = ` record`(scala.Tuple2("recipient", ` lfdomainapi`.Value.encode(value.recipient)), scala.Tuple2("nonce", ` lfdomainapi`.Value.encode(value.nonce)), scala.Tuple2("id", ` lfdomainapi`.Value.encode(value.id)), scala.Tuple2("evidence", ` lfdomainapi`.Value.encode(value.evidence)), scala.Tuple2("quantity", ` lfdomainapi`.Value.encode(value.quantity)), scala.Tuple2("assetCode", ` lfdomainapi`.Value.encode(value.assetCode)), scala.Tuple2("metadata", ` lfdomainapi`.Value.encode(value.metadata)), scala.Tuple2("securityRoot", ` lfdomainapi`.Value.encode(value.securityRoot)));
          override def read(argValue: ` rpcvalue`.Value.Sum): _root_.scala.Option[_root_.co.topl.daml.models.Topl.MintAssetOffChain] = argValue.record.flatMap(((` r` ) => if (` r`.fields.length.==(8))
            ` r`.fields(0) match {
                                      ...
                                      case ` rpcvalue`.RecordField((""| "metadata"), _root_.scala.Some(zv6)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Text](zv6) match {
                                        case _root_.scala.Some(metadata) => (` r`.fields(7) match {
                                          case ` rpcvalue`.RecordField((""| "securityRoot"), _root_.scala.Some(zv7)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Text](zv7) match {
                                            case _root_.scala.Some(securityRoot) => Some(MintAssetOffChain(recipient, nonce, id, evidence, quantity, assetCode, metadata, securityRoot))
      ...
      override protected val ` dataTypeId` = ` mkDataTypeId`(`Package IDs`.Topl, "Topl", "MintAssetOffChain");
      implicit def `MintAssetOffChain LfEncodable`: ` lfdomainapi`.encoding.LfEncodable[_root_.co.topl.daml.models.Topl.MintAssetOffChain] = {
        final class $anon extends ` lfdomainapi`.encoding.LfEncodable[_root_.co.topl.daml.models.Topl.MintAssetOffChain] {
          override def encoding(lte: ` lfdomainapi`.encoding.LfTypeEncoding): lte.Out[_root_.co.topl.daml.models.Topl.MintAssetOffChain] = {
            ...
            {
              val `recordFields `: lte.RecordFields[_root_.co.topl.daml.models.Topl.MintAssetOffChain] = lte.RecordFields.xmapN(lte.fields(`view `.recipient), lte.fields(`view `.nonce), lte.fields(`view `.id), lte.fields(`view `.evidence), lte.RecordFields.tupleN(lte.fields(`view `.quantity), lte.fields(`view `.assetCode), lte.fields(`view `.metadata), lte.fields(`view `.securityRoot)))({
                case scala.Tuple5(recipient, nonce, id, evidence, scala.Tuple4(quantity, assetCode, metadata, securityRoot)) => _root_.co.topl.daml.models.Topl.MintAssetOffChain(recipient, nonce, id, evidence, quantity, assetCode, metadata, securityRoot)
              })({
                case _root_.co.topl.daml.models.Topl.MintAssetOffChain(recipient, nonce, id, evidence, quantity, assetCode, metadata, securityRoot) => scala.Tuple5(recipient, nonce, id, evidence, scala.Tuple4(quantity, assetCode, metadata, securityRoot))
              });
