...
import com.daml.lf.transaction.{Node, NodeId, SubmittedTransaction, TransactionVersion, Versioned, VersionedTransaction}
        ...
        values0 match {
          ...
          case FrontStackCons(value, values) =>
            value match {
              ...
              case ValueContractId(_) | ValueInt64(_) | ValueText(_) | ValueTimestamp(_) | ValueParty(_) | ValueBool(
                    _
                  ) | ValueDate(_) | ValueUnit | ValueNumeric(_) =>
