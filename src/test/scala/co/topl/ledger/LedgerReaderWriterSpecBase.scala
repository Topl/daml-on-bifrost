...
import co.topl.ledger.ParticipantStateIntegrationSpecBase.ParticipantState

import java.util.concurrent.Executors
import com.daml.ledger.configuration.LedgerId
import com.daml.ledger.participant.state.kvutils.api.{KeyValueParticipantStateReader, KeyValueParticipantStateWriter}
...
class LedgerReaderWriterSpecBase extends ParticipantStateIntegrationSpecBase(s"In-memory ledger/participant") {
